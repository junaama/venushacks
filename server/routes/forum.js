...
router.post('/', createForumSchema, awaitHandlerFactory(forumController.createForum)); // localhost:3000/api/v1/forums
router.patch('/id/:id',updateForumSchema, awaitHandlerFactory(forumController.updateForum)); // localhost:3000/api/v1/forums/id/vid , using patch for partial update
