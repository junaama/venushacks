...
router.post('/', awaitHandlerFactory(videoController.createVideo)); // localhost:3000/api/v1/videos
router.patch('/id/:id', awaitHandlerFactory(videoController.updateVideo)); // localhost:3000/api/v1/videos/id/vid , using patch for partial update
